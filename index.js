...
function make(){
   for (let carsmake of carList){
      console.log("-")
      console.log("For cars makes, we have: " + carsmake.make)
...
function model(){
   for (let carsmodel of carList){
      console.log("-")
      console.log("The best cars models, we have: " + carsmodel.model)
      document.getElementById("result-message").innerHTML = "Please, check the console for more information!"
   }
}
...
function color(){
   for (let carscolor of carList){
      console.log("-")
      console.log("For the nice car colors, we have: " + carscolor.color)
      document.getElementById("result-message").innerHTML = "Please, check the console for more information!"
   }
}
